...
export default function ProfileStep({ index, title, description, completed, isLastStep, handleNavigation }: ProfileStepProps) {
    ...
    return (
        ...
        >
            <View style={styles.iconAndLineContainer}>
                <View style={completed ? styles.successContainer : styles.numberContainer}>
                    {completed ? (
