...
export default function AcctDetailsCard({
  ...
  const [isTransferOptionModalVisible, setIsTransferOptionModalVisible] =
    useState<boolean>(false);

  const navigation =
    useNavigation<StackNavigationProp<PrivateNavigatorParamList>>();
  ...
  const filteredActions = ACTIONS_DATA?.filter(action =>
