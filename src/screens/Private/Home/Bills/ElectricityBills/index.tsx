...
type UtilityBillSubscriptionScreenNavigationProp = StackNavigationProp<WalletStackParamList, 'ConfirmTransactionScreen'>;

interface IUtilityBillPlan {
    name: string;
    code: string;
    amount: string;
}

interface IUtilityBillSubscriptionProps {
    navigation: UtilityBillSubscriptionScreenNavigationProp;
    route: RouteProp<WalletStackParamList, 'ElectricityBillSubscriptionScreen'>;
}

interface IPlansMap {
    DSTV: IUtilityBillPlan[];
    GoTV: IUtilityBillPlan[];
    Startimes: IUtilityBillPlan[];
    TSTV: IUtilityBillPlan[];
}

const plans: IUtilityBillPlan[] = [
    {
    ...
    {
        name: 'UtilityBill Confam Streaming Subscription',
        code: '2',
        amount: '1,200'
    }
]

const DSTVPlans: IUtilityBillPlan[] = [
    {
...
const GoTVPlans: IUtilityBillPlan[] = [
    {
...
const StartimesPlans: IUtilityBillPlan[] = [
    {
...
export default function UtilityBillsSubscription({ navigation, route }: IUtilityBillSubscriptionProps) {
    const [showProductModal, setShowProductModal] = useState<boolean>(false);
    const [selectedPlan, setSelectedPlan] = useState<IUtilityBillPlan>({ name: '', code: '', amount: '' })
